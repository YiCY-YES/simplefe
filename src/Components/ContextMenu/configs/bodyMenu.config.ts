...
import tokei from '../../Properties/tokei'
	...
	return [
        [
			{
				...
				visible: !_focusingPath.startsWith('xplorer://') && !_focusingPath.startsWith('Search') ,
				shortcut: 'Alt+T',
				icon: 'terminal',
			...
			},
			{
				...
				visible: (await isVSCodeInstalled()) && !_focusingPath.startsWith('xplorer://') && !_focusingPath.startsWith('Search'),
		...
		[
			...
			},
			{
                ...
                visible: !_focusingPath.startsWith('Search'),
				shortcut: 'Ctrl+P',
